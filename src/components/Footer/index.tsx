          ...
          <div className="max-w-[330px] w-full">
            ...
            <ul className="flex flex-col gap-3">
              <li className="flex gap-4.5">
                ...
                <span
                  dangerouslySetInnerHTML={{ __html: site.address }}
                  className="text-dark text-custom-sm"
                />
              </li>

              <li>
                <a href={`https://wa.me/${site.whatsapp}`} className="flex items-center gap-4.5">
                  <svg
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
              ...
              <li>
                <a href={`mailto:${site.mailAdmin}`} className="flex items-center gap-4.5">
                  <svg
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
            ...
            <div className="flex items-center gap-4 mt-7.5">
              {Object.entries(site.sosmed).map(([key, { url, icon }]) => {
                const Icon = iconMap[icon];
                if (!Icon) return null;

                return (
                  <a key={key} href={url} target="_blank" rel="noopener noreferrer" className="ease-out duration-200 hover:text-blue" aria-label={key}>
                    <Icon size={24} />
                  </a>
                );
              })}
        ...
        <div className="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0">
          <div className="flex gap-5 flex-wrap items-center justify-between">
            <p className="text-dark font-medium">
              &copy; {year}. All rights reserved by {site.companyName}.
            </p>
