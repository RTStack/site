...
const QuickViewModal = () => {
  ...
  return (
    <div
      ...
      } fixed top-0 left-0 overflow-y-auto no-scrollbar w-full h-screen sm:py-20 xl:py-25 2xl:py-[230px] bg-dark/80 sm:px-8 px-4 py-5 backdrop-blur-sm`}
    >
                ...
                <div className="relative z-1 overflow-hidden flex items-center justify-center w-full sm:min-h-[508px] bg-gray-1 rounded-lg border border-gray-3">
                  <div>
                    ...
                    {imageSrc ? (
                      ...
                      <div className="w-[400px] h-[400px] bg-gray-100 flex items-center justify-center text-sm text-gray-500 rounded-lg">
            ...
            <div className="max-w-[445px] w-full">
              ...
              <div className="flex flex-wrap justify-between gap-5 mt-6 mb-7.5">
                <div>
                  ...
                  <span className="flex items-center gap-2">
                    ...
                    <span className="text-green-600 text-xl xl:text-heading-4">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                        height="24"
              ...
              <div className="flex items-center justify-between w-full gap-2">
                <button
                    ...
                    className={`flex w-full items-center justify-center gap-2 font-medium text-white bg-green py-3 px-7 rounded-md ease-out duration-200 hover:bg-green-dark ${
                ...
                <button
                  ...
                  className={`flex w-full items-center justify-center gap-2 font-medium text-white bg-dark py-3 px-6 rounded-md ease-out duration-200 hover:bg-opacity-95 `}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="20"
