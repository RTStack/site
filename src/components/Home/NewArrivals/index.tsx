        ...
        <div className="mb-7 flex items-center justify-between">
          <div>
            ...
            <h2 className="font-semibold text-xl xl:text-heading-6 text-dark">
              Unit Favorit Paling Sering Disewa Pelanggan
            </h2>
            <p className="text-sm">Cari yang terbukti sewaan paling laris? Paling sering dipesan, Review-nya mantep-mantep, Minim drama, kualitas poll</p>
          </div>
