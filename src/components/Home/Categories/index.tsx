...
const items = categories.map((cat, key) => ({
  id: key,
  name: cat.name,
  title: cat.title,
  img: cat.img,
          ...
          <div className="mb-10 flex items-center justify-between">
            <div>
              ...
              <h2 className="font-semibold text-xl xl:text-heading-6 text-dark">
                Perangkat Lain yang disewakan
              </h2>
              <p className="text-sm">All In One Rental Center - Ngapain Beli Kalau Bisa Sewa? Di sini Satu Tempat, Banyak Alat!</p>
            </div>

            <div className="flex items-center gap-3">
              <button aria-label="Previous slide" onClick={handlePrev} className="swiper-button-prev">
                <svg
              ...
              <button aria-label="Next slide" onClick={handleNext} className="swiper-button-next">
                <svg
                  className="fill-current"
                  width="24"
                  height="24"
