...
const getFaqs = (category: string, area?: string): FaqItem[] => {
  ...
  const inject = (text: string) =>
    text
      ...
      .replace(/\{area\}/gi, areaLC || "terdekat");
  ...
  return [
    ...
    {
      question: `Apakah ada biaya pengiriman ke {area}?`,
      answer: `Biaya pengiriman tergantung lokasi kamu.<br/>Kalau masih dalam area {area}, <strong>pengiriman GRATIS</strong>.<br/>
