...
const SingleItem = ({ item }) => {
  ...
  return (
    <div className="flex items-center justify-between border-t border-gray-3 py-5 px-7.5">
          ...
          <div className="w-full flex items-center gap-5.5">
            ...
            <div>
              <h3 className="text-dark ease-out duration-200 hover:text-blue">
                <a href="#"> {item.title} <span className="text-custom-sm"></span></a>
              </h3>
            </div>
          </div>
        </div>
      ...
      <div className="min-w-[275px] flex items-center justify-center">
        <div className="w-max flex items-center rounded-md border border-gray-3 text-center">
          <button
