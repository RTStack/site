...
import { mainMenu, menuData } from "./menuData";
        ...
        >
          ...
          <div className="xl:w-auto flex-col sm:flex-row w-full flex sm:justify-between sm:items-center sm:gap-10">
            <Link
              href="/"
              title={site.name}
              className="flex-shrink-0 text-blue flex items-center gap-2 cursor-pointer py-1 text-xl font-bold self-center uppercase"
              aria-label="Home"
            >
              <svg
              ...
              >
                <path
                  fillRule="evenodd"
                  d="M30.5,1.74l9.52,5.5c4.02,2.32,6.5,6.62,6.5,11.26v10.99c0,4.65-2.48,8.94-6.5,11.26l-9.52,5.5c-4.02,2.32-8.98,2.32-13.01,0l-9.52-5.5c-4.02-2.32-6.5-6.62-6.5-11.26v-10.99c0-4.65,2.48-8.94,6.5-11.26L17.49,1.74c4.02-2.32,8.98-2.32,13.01,0ZM5.86,18.58l14.89-8.6c2.01-1.16,4.49-1.16,6.5,0l8.35,4.82c1.34.77,2.17,2.21,2.17,3.76v.7c0,.83-.9,1.36-1.63.94l-9.98-5.76c-1.34-.77-2.99-.77-4.34,0l-13.81,7.98c-1.34.77-2.17,2.21-2.17,3.75v3.31c0,3.1,1.65,5.96,4.34,7.51l9.47,5.47c2.68,1.55,5.99,1.55,8.67,0l9.48-5.47c2.68-1.55,4.34-4.41,4.34-7.51v-.03l-14.89,8.6c-2.01,1.16-4.49,1.16-6.5,0l-8.34-4.82c-1.34-.77-2.17-2.21-2.17-3.75v-.69c0-.83.9-1.36,1.63-.94l9.97,5.75c1.34.77,2.99.77,4.33,0l13.81-7.97c1.34-.77,2.17-2.21,2.17-3.75v-3.33c0-3.1-1.65-5.96-4.34-7.51l-9.48-5.47c-2.68-1.55-5.99-1.55-8.67,0l-9.47,5.47c-2.68,1.55-4.34,4.41-4.34,7.51v.05Z"
                ></path>
              </svg>
              <span
                itemProp="name"
            ...
            <div className="max-w-[475px] w-full heading">
              {/* <!--=== Main Nav Start ===--> */}
              <div
                className={`w-[calc(100vw-2rem)] absolute right-4 top-full xl:static xl:w-auto h-auto invisible xl:visible xl:flex items-center justify-between ${
                  navigationOpen &&
                  `!visible bg-white shadow-lg border border-gray-3 max-h-[calc(100vh-120px)] overflow-y-scroll rounded-md p-5`
                }`}
              >
                <nav>
                  {/* <!-- Main Menu --> */}
                  <ul className="flex xl:items-center flex-col xl:flex-row gap-5 xl:gap-6 font-normal uppercase">
                      ...
                      menuItem.submenu ? (
                        ...
                        >
                          <Link
                            ...
                            className={`hover:text-blue text-custom-sm text-dark flex py-2`}
                          >
                            {menuItem.name}
                          </Link>
                        </li>
          ...
          <div className="flex w-full lg:w-auto justify-between items-center gap-5">
            ...
            <div className="flex items-center gap-3.5">
              ...
              <div>
                ...
                <Link
                  href={`https://wa.me/${site.whatsapp}?text=Hai+${site.name},%0ASaya+Mau+Sewa+`}
                  target="_blank"
      ...
      <div className="border-t border-gray-3">
        <div className="max-w-[1170px] mx-auto px-4 sm:px-7.5 xl:px-0">
          <div className="flex items-center justify-between">
            {/* <!-- Main Nav Start --> */}
            <nav>
              <ul className="hidden lg:flex lg:items-center flex-col lg:flex-row gap-5 lg:gap-6">
